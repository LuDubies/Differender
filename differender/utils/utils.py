...
def get_tf(id, res):
    if  id == 'tf1':
        ...
        return tex_from_pts(torch.tensor([[0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
            [0.0840, 0.8510, 0.8, 0.5, 0.0000],
            [0.0850, 0.8510, 0.5, 0.2, 0.08],
            [0.1844, 0.6, 0.6, 0.4, 0.08],
            [0.1890, 0.8, 0.7, 0.4, 0.0000],
            [0.2444, 0.9, 0.5, 0.6, 0.0000],
            [0.2528, 0.7, 0.005, 0.3, 0.07],
            [0.2621, 0.8, 0.5, 0.6, 0.0000],
            [0.3407, 0.8, 0.8, 0.8, 0.0000],
            [0.3601, 0.8, 0.8, 0.83, 0.3],
            [0.4475, 0.8, 0.8, 0.83, 0.3],
            [0.4655, 0.8, 0.8, 0.83, 0.0000],
            [1.0000, 0.0000, 0.0000, 0.0000, 0.0000]]), res)
    elif id == 'tf2':
        return tex_from_pts(torch.tensor([[0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
